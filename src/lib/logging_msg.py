...
MSG_CLIENT_ALREADY_HAS_ASSIGNED_CONNECTION = \
  "Client already has an assigned connection"
...
MSG_SEND_FILE_METHOD_NOT_IMPLEMENTED = \
  "'send_file' method must be implemented in subclass"
MSG_RECEIVE_FILE_METHOD_NOT_IMPLEMENTED = \
  "'receive_file' method must be implemented in subclass"
...
MSG_SENDING_FILE_USING_STOP_AND_WAIT = \
